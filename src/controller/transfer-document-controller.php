<?php 
   ...
   // Update the sendNotification function to include more detailed messages
   function sendNotification($createNotification, $message, $email, $user_id) {
       ...
       // Email notification code (commented out in original)
   }
   
   // In the transfer_document action, update the notification messages
